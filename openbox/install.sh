...
sudo pacman -S openbox xorg-server xorg-xinit xorg-xset alsa-utils pulseaudio-bluetooth bluez bluez-utils blueman git vim kitty obconf lxappearance-obconf menumaker tint2 firefox pcmanfm ranger zip unzip xarchiver feh udisks2 udiskie numlockx wmctrl xdotool python-pillow;
